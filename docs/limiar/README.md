...
Renderização, controlador em primeira pessoa (WASD, sprint, pulo com "hold", step-up, rampas, kick de pouso), mundo de teste ("Campo de Provas"), HUD de debug, painel de tuning, testes unitários e smoke test e2e. **Sem armas, inimigos ou loot** — os contratos e slots para eles já existem no código e estão descritos no design técnico (§11). Próximo passo: M1 — gunplay ([roadmap](04-roadmap.md)).
...
| 03 | não existe — o número foi reservado e permanece livre | — |
